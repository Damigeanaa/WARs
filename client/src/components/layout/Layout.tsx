...
const mainNavigation = [
  ...
  { name: 'Holidays', href: '/holiday-requests', icon: Calendar },
]
...
const systemNavigation = [
  ...
  { name: 'Notification Test', href: '/notification-test', icon: TestTube },
  { name: 'Mobile Optimization', href: '/mobile-optimization', icon: Smartphone },
]
